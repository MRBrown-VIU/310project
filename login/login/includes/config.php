...
****************/
mysql_connect('localhost', 'ertechca_login', '2scyPm9TC{qp') or trigger_error("Unable to connect to the database: " . mysql_error());
mysql_select_db('ertechca_login') or trigger_error("Unable to switch to the database: " . mysql_error());
