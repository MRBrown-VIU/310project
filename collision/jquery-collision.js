...
function($){
	...
	CollisionCoords.prototype.toString = function() { return (this.proto["get"]?"#"+this.proto.get(0).id:"")+"["+[this.x1,this.y1,this.x2,this.y2].join(",")+"]"; };
	
	// CollisionCoords.EPSILON = 0.001;
	
	// 2.0 is too much
	// 1.0 is not enough
	CollisionCoords.EPSILON = 1.500;
